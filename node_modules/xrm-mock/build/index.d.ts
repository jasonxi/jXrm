...
declare module "xrm-mock/attributes/attribute/attribute.mock" {
    ...
    export class AttributeMock<TControl extends ControlMock, TValue extends AttributeReturnType> implements Xrm.Attributes.Attribute {
...
declare module "xrm-mock/controls/standardcontrol/standardcontrol.mock" {
    ...
    export class StandardControlMock<TControl extends StandardControlMock<TControl, TAttribute, TValue>, TAttribute extends AttributeMock<TControl, TValue>, TValue extends AttributeReturnType> extends ControlMock implements Xrm.Controls.StandardControl {
        disabled: boolean;
...
declare module "xrm-mock/controls/autolookupcontrol/autolookupcontrol.mock" {
    ...
    export class AutoLookupControlMock<TControl extends AutoLookupControlMock<TControl, TAttribute, TValue>, TAttribute extends AttributeMock<TControl, TValue>, TValue extends AttributeReturnType> extends StandardControlMock<TControl, TAttribute, TValue> implements Xrm.Controls.AutoLookupControl {
...
declare module "xrm-mock/controls/booleancontrol/booleancontrol.mock" {
    ...
    import { IAttStandardControlComponents, IStandardControlComponents, StandardControlMock } from "xrm-mock/controls/standardcontrol/standardcontrol.mock";
    export class BooleanControlMock extends StandardControlMock<BooleanControlMock, BooleanAttributeMock, boolean> implements Xrm.Controls.StandardControl {
...
declare module "xrm-mock/attributes/enumattribute/enumattribute.mock" {
    ...
    export class EnumAttributeMock<TControl extends ControlMock, TValue extends number | boolean> extends AttributeMock<TControl, TValue> implements Xrm.Attributes.EnumAttribute {
        initialValue: TValue;
...
declare module "xrm-mock/attributes/dateattribute/dateattribute.mock" {
    ...
    import { AttributeMock, IAttributeComponents } from "xrm-mock/attributes/attribute/attribute.mock";
    export class DateAttributeMock extends AttributeMock<DateControlMock, Date> implements Xrm.Attributes.DateAttribute {
...
declare module "xrm-mock/attributes/lookupattribute/lookupattribute.mock" {
    ...
    import { AttributeMock, IAttributeComponents } from "xrm-mock/attributes/attribute/attribute.mock";
    export class LookupAttributeMock extends AttributeMock<LookupControlMock, Xrm.LookupValue[]> implements Xrm.Attributes.LookupAttribute {
        private static defaultComponents;
        isPartyList: boolean;
...
declare module "xrm-mock/attributes/numberattribute/numberattribute.mock" {
    ...
    import { AttributeMock, IAttributeComponents } from "xrm-mock/attributes/attribute/attribute.mock";
    export class NumberAttributeMock extends AttributeMock<NumberControlMock, number> implements Xrm.Attributes.NumberAttribute {
        private static defaultComponents;
        min: number;
        max: number;
        precision: number;
...
declare module "xrm-mock/attributes/optionsetattribute/optionsetattribute.mock" {
    ...
    import { OptionSetValueMock } from "xrm-mock/optionsetvalue/optionsetvalue.mock";
    import { EnumAttributeMock, IEnumAttributeComponents } from "xrm-mock/attributes/enumattribute/enumattribute.mock";
    export class OptionSetAttributeMock extends EnumAttributeMock<OptionSetControlMock, number> implements Xrm.Attributes.OptionSetAttribute {
...
declare module "xrm-mock/attributes/stringattribute/stringattribute.mock" {
    ...
    import { AttributeMock, IAttributeComponents } from "xrm-mock/attributes/attribute/attribute.mock";
    export class StringAttributeMock extends AttributeMock<StringControlMock, string> implements Xrm.Attributes.StringAttribute {
